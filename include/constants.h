 ...
 * @def SPEC_MACRO_ELSE
 *
 * The %else constrict for conditional macros.
 */
#define SPEC_MACRO_ELSE "%else"
...
/**
 * @def SPEC_FILES_DEFATTR
 *
 * The %defattr macro for the %files section(s).
 */
#define SPEC_FILES_DEFATTR "%defattr"
